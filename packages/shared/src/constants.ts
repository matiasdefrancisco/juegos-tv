import { Difficulty, GameMode, GameSettings, RoundMode, Word, WordLevel } from './types.js';
...
export function getDifficultyMeta(id: Difficulty): DifficultyMeta {
...
export const ATTEMPTS_OPTIONS: Array<{ value: number; label: string; hint: string }> = [
...
export const ALL_PLAY_OPTIONS: Array<{ value: number; label: string; hint: string }> = [
